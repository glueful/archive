...
namespace Glueful\Extensions\Archive\Migrations;

use Glueful\Database\Migrations\MigrationInterface;
use Glueful\Database\Schema\Interfaces\SchemaBuilderInterface;

/**
 * Archive system tables — core `src/Services/Archive` schema. Owned by the `glueful/archive`
 * extension; registered only when `archive.enabled` is true (default off).
 */
